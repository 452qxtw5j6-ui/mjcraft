...
const GENERIC_FILE_EXTENSION_PATTERN = '[A-Za-z0-9][A-Za-z0-9_-]{0,31}'
const FILE_PATH_REGEX_SOURCE = `(?:^|[\\s([\\{<])((?:/|~/|\\./|\\.\\./|[A-Za-z0-9_][\\w\\-./@]*)[\\w\\-./@]*\\.(?:${GENERIC_FILE_EXTENSION_PATTERN}))(?=[\\s)\\]}\\.,:;!?>]|$)`
...
const FILE_PATH_TARGET_REGEX = new RegExp(
  `^(?!https?://|mailto:|ftp://|data:)(?:/|~/|\\./|\\.\\./|[A-Za-z0-9_][\\w\\-./@]*)[\\w\\-./@]*\\.(?:${GENERIC_FILE_EXTENSION_PATTERN})$`,
  'i'
)
