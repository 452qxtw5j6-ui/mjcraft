...
import type { LoadedPersona } from '../personas/types'
...
export interface BroadcastEventMap {
  ...
  [RPC_CHANNELS.personas.CHANGED]: [workspaceId: string, personas: LoadedPersona[]]
  ...
  [RPC_CHANNELS.menu.FOCUS_SIDEBAR]: []
  [RPC_CHANNELS.menu.FOCUS_NAVIGATOR]: []
  [RPC_CHANNELS.menu.FOCUS_CHAT]: []
  [RPC_CHANNELS.menu.DELETE_CURRENT_SESSION]: []
