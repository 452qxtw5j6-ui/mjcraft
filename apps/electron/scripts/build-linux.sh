...
echo "=== Building Noodle AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Noodle-x86_64.AppImage or Noodle-aarch64.AppImage
BUILT_APPIMAGE_NAME="Noodle-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Noodle-x64.AppImage, Noodle-arm64.AppImage
APPIMAGE_NAME="Noodle-${ARCH}.AppImage"
